    ...
    <div className=' flex flex-col items-center justify-center mt-10 bg-cyan-600 mx-[10%] rounded-xl '>
      ...
      <form onSubmit={submit}>
        <div className=" flex items-center justify-center mt-5 max-md:ml-5">
          ...
          <input type="text" value={title} onChange={(event) => { settitle(event.target.value) }} className=" bg-slate-500  max-md:w-[70%] max-sm:w-[50%] max-md:h-5 rounded-3xl p-3 text-black text-lg font-medium border-[3px] border-violet-600" id="tittle" />
        </div>
